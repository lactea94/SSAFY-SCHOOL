...
@Getter
@Setter
@ApiModel("GameNoticeResponse")
public class GameNoticeRes {
    ...
    @ApiModelProperty(name = "GameNotice CreatedDate", example = "2022-05-04 17:56:15:121543")
    ...
    public GameNoticeRes(GameNotice entity) {
